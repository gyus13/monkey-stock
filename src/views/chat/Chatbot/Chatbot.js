...
function Chatbot() {
    ...
    const textQuery = async (text) => {
        ...
        try {
            ...
            const response = await Axios.post(`${window.location.host}:8000/api/dialogflow/textQuery`, textQueryVariables)
    ...
    const eventQuery = async (event) => {
        ...
        try {
            //I will send request to the textQuery ROUTE 
            const response = await Axios.post(`${window.location.host}:8000/api/dialogflow/eventQuery`, eventQueryVariables)
